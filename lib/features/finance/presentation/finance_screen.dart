...
class FinanceScreen extends ConsumerWidget {
        ...
        children: [
          SizedBox(
            ...
            child: accounts.isEmpty
                ? Center(child: Text('Belum ada akun.',
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Spacer(),
                            Text(formatMinor(a.currentBalanceMinor),
                                style: Theme.of(context)
                                    .textTheme
                                    .titleLarge
                                    ?.copyWith(
          ...
          if (flow.isEmpty)
            ...
            ...flow.map((e) {
              ...
              return ListTile(
                ...
                subtitle:
                    Text(df.format(e.occurredAt.toLocal())),
                trailing: Text(
  ...
  Future<void> _manualSheet(
    ...
    if (accounts.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Buat akun terlebih dahulu (otomatis ada saat onboarding).')));
      return;
    }
  ...
  Future<void> _transferSheet(BuildContext context, WidgetRef ref) async {
    ...
    if (accounts.length < 2) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Transfer butuh minimal dua akun.')));
      return;
    }
    ...
    final r = await service.transfer(
        fromAccountId: from, toAccountId: to, amountMinor: amount);
    if (!context.mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
            r.isSuccess ? 'Transfer tersimpan.' : r.failure!.message)));
  }
}
